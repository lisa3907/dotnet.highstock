...
namespace DotNet.HighStock.Options
{
    ...
    public class YAxis
    {
        ...
        /// </summary>
        public DateTimeLabel DateTimeLabelFormats
        {
            get; set;
        }
        ...
        /// <summary>
        /// The dash or dot style of the grid lines. For possible values, see <a href='http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highstock.com/tree/master/samples/highstock/plotoptions/series-dashstyle-all/'>this demonstration</a>.
        /// Default: Solid
        /// </summary>
        public DashStyles? GridLineDashStyle
        {
            get; set;
        }
        ...
        [Obsolete("Deprecated. Renamed to <code>minRange</code> as of Highstock 2.2.")]
        ...
        /// <summary>
        /// The dash or dot style of the minor grid lines. For possible values, see <a href='http://jsfiddle.net/gh/get/jquery/1.7.1/highslide-software/highstock.com/tree/master/samples/highstock/plotoptions/series-dashstyle-all/'>this demonstration</a>.
        /// Default: Solid
        /// </summary>
        public DashStyles? MinorGridLineDashStyle
        {
            get; set;
        }
        ...
        /// Default: outside
        /// </summary>
        public TickPositions? MinorTickPosition
        {
            get; set;
        }
        ...
        public YAxisPlotBands[] PlotBands
        {
            get; set;
        }

        public YAxisPlotLines[] PlotLines
        {
            get; set;
        }
        ...
        /// Default: between
        /// </summary>
        public Placement? TickmarkPlacement
        {
            get; set;
        }
