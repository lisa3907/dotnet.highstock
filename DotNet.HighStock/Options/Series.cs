...
namespace DotNet.HighStock.Options
{
    ...
    public class Series
    {
        ...
        [Obsolete("This method is deprecated as of version 2.0. Instead, use options preprocessing as described in <a href='http://docs.highstock.com/#preprocessing'>the docs</a>.")]
        [JsonFormatter("{0}")]
        ...
        [Obsolete("This method is deprecated as of version 2.0. Instead, load the data using jQuery.ajax and use options preprocessing as described in <a href='http://docs.highstock.com/#preprocessing'>the docs</a>.")]
        ...
        /// <summary>
        /// The sequential index of the series in the legend.  <div class='demo'>Try it:  <a href='http://jsfiddle.net/gh/get/jquery/1.7.1/highslide-software/highstock.com/tree/master/samples/highstock/series/legendindex/' target='_blank'>Legend in opposite order</a> </div>.
        /// </summary>
        ...
        [JsonFormatter(addPropertyName: false, useCurlyBracketsForObject: false)]
        public PlotOptionsAreaspline PlotOptionsAreaspline
        {
            get;
            set;
        }
        ...
        [JsonFormatter(addPropertyName: false, useCurlyBracketsForObject: false)]
        public PlotOptionsBar PlotOptionsBar
        {
            get;
            set;
        }
        ...
        [JsonFormatter(addPropertyName: false, useCurlyBracketsForObject: false)]
        public PlotOptionsColumn PlotOptionsColumn
        {
            get;
            set;
        }
        ...
        [JsonFormatter(addPropertyName: false, useCurlyBracketsForObject: false)]
        public PlotOptionsLine PlotOptionsLine
        {
            get;
            set;
        }
        ...
        [JsonFormatter(addPropertyName: false, useCurlyBracketsForObject: false)]
        public PlotOptionsSpline PlotOptionsSpline
        {
            get;
            set;
        }
        ...
        [JsonFormatter(addPropertyName: false, useCurlyBracketsForObject: false)]
        public PlotOptionsPie PlotOptionsPie
        {
            get;
            set;
        }
        ...
        [JsonFormatter(addPropertyName: false, useCurlyBracketsForObject: false)]
        public PlotOptionsSeries PlotOptionsSeries
        {
            get;
            set;
        }
        ...
        [JsonFormatter(addPropertyName: false, useCurlyBracketsForObject: false)]
        public PlotOptionsScatter PlotOptionsScatter
        {
            get;
            set;
        }
        ...
        [JsonFormatter(addPropertyName: false, useCurlyBracketsForObject: false)]
        public PlotOptionsArearange PlotOptionsArearange
        {
            get;
            set;
        }
        ...
        [JsonFormatter(addPropertyName: false, useCurlyBracketsForObject: false)]
        public PlotOptionsAreasplinerange PlotOptionsAreasplinerange
        {
            get;
            set;
        }
        ...
        [JsonFormatter(addPropertyName: false, useCurlyBracketsForObject: false)]
        public PlotOptionsColumnrange PlotOptionsColumnrange
        {
            get;
            set;
        }
        ...
        [JsonFormatter(addPropertyName: false, useCurlyBracketsForObject: false)]
        public PlotOptionsGauge PlotOptionsGauge
        {
            get;
            set;
        }
        ...
        [JsonFormatter(addPropertyName: false, useCurlyBracketsForObject: false)]
        public PlotOptionsBoxplot PlotOptionsBoxplot
        {
            get;
            set;
        }
        ...
        [JsonFormatter(addPropertyName: false, useCurlyBracketsForObject: false)]
        public PlotOptionsWaterfall PlotOptionsWaterfall
        {
            get;
            set;
        }
        ...
        [JsonFormatter(addPropertyName: false, useCurlyBracketsForObject: false)]
        public PlotOptionsFunnel PlotOptionsFunnel
        {
            get;
            set;
        }
        ...
        [JsonFormatter(addPropertyName: false, useCurlyBracketsForObject: false)]
        public PlotOptionsBubble PlotOptionsBubble
        {
            get;
            set;
        }
