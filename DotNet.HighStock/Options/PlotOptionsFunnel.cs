...
namespace DotNet.HighStock.Options
{
    ...
    public class PlotOptionsFunnel
    {
        ...
        /// Default: ["50%", "50%"]
        /// </summary>
        public PercentageOrPixel[] Center
        {
            get; set;
        }
        ...
        public PercentageOrPixel Height
        {
            get; set;
        }
        ...
        /// </summary>
        [JsonFormatter(addPropertyName: true, useCurlyBracketsForObject: false)]
        public PercentageOrPixel NeckHeight
        {
            get; set;
        }
        ...
        /// </summary>
        [JsonFormatter(addPropertyName: true, useCurlyBracketsForObject: false)]
        public PercentageOrPixel NeckWidth
        {
            get; set;
        }
        ...
        /// </summary>
        [JsonFormatter(addPropertyName: true, useCurlyBracketsForObject: false)]
        public PercentageOrPixel Width
        {
            get; set;
        }
    }
